...
- `btc_radar` — Bitcoin / crypto board + equity-macro health dashboard
...
- Bitcoin radar: `python3 -m btc_radar --demo` (offline correlated tape). Live polls
 CoinGecko + Yahoo Finance + alternative.me Fear & Greed; default port `8810`.
